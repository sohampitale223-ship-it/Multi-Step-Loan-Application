...
function LoanApplication() {
  ...
  const resume = () => {
    ...
    setCurrentStep(saved.currentStep === 6 && !activeStep6 ? 7 : Math.min(Math.max(saved.currentStep, 1), 7))
  }
  ...
  return <div className="application-page">
    ...
    <section className="application-card" aria-labelledby="step-heading">
      ...
      {currentStep === 7 && <div className="step-placeholder"><h2 id="step-heading">Step 7 – Documents</h2><p>Coming in the next implementation.</p><button className="button button--secondary" type="button" onClick={() => setCurrentStep(showCoApplicant ? 6 : 5)}>← Back</button></div>}
